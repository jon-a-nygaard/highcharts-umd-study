...
var Adapter = require('highcharts/lib/adapters/standalone-framework.src'),
    Highcharts = require('highcharts/lib/highcharts.src')(Adapter);
...
console.log("HighchartsAdapter", HighchartsAdapter);
},{"highcharts/lib/adapters/standalone-framework.src":2,"highcharts/lib/highcharts.src":3}],2:[function(require,module,exports){
/**
    ...
    */
    ...
    (function (H) {
        var Chart = H.Chart,
            ...
            pick = H.pick,
            addEvent = H.addEvent;
        console.log(JSON.stringify(H.each));
        console.dir(H);
